...
def parse_args(base_parser, args, namespace):
    ...
    # noise analysis arguments
    parser.add_argument("--mode", default="train", type=str)
    parser.add_argument("--save_cnt", default=5, type=int)
    parser.add_argument("--sample_itr", default=50, type=int)
    parser.add_argument("--layer_type", default="attn", type=str)
